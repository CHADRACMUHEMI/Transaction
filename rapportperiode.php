...
$pdf->SetAuthor('james');
$pdf->SetTitle('RAPPORT D OPERATION PERIODIQUE');
$pdf->SetSubject('RAPPORT D OPERATION PERIODIQUE');
...
$pdf->SetFont('helvetica', 'B', 12);
    ...
    $pdf->Write(0, 'RAPPORT D OPERATION DE COMPTE DURANT UNE PERIODE ', '', 0, 'C', true, 0, false, false, 0);
...
$pdf->Write(0, '_______________________________________________________', '', 0, 'C', true, 0, false, false, 0);
...
//         if(!empty($donneesSytheseMembre['diagnCons'])){
    $tbl="";
        ...
        $tbl .="<div style='text-align:center; width:100px;['>
                <h5 >Nom : kambale</h5>
                <h5 >Postnom : kambale</h5>
                <h5 >Prenom : kambale</h5>
