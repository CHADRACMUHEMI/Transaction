...
$pdf->SetAuthor('james');
$pdf->SetTitle('Gestion de Transaction de Client');
$pdf->SetSubject('Gestion de Transaction de Client');
...
$pdf->SetFont('helvetica', 'B', 16);
    ...
    $pdf->Write(0, 'RAPPORT SYNTHETIQUE DU MEMBRE ', '', 0, 'C', true, 0, false, false, 0);
...
//         // $numDomaine=0;
            ...
            $tbl .= '<tr>
                    ...
                    <td  align="left"> jhhh</td>
                    <td  align="left">jjkkk</td>
                    <td  align="left">ghgggg</td>
                   </tr>';
            $tbl .= '<tr>
                   <td align="left">ddd</td>
                   <td  align="left"> jhhh</td>
