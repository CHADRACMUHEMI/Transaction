...
<main id="main">
    ...
    <div class="col col-md-11 mx-11 shadow-lg">
                <form method="post" action="save_compte.php">
            <div class="row mx-2">
                <div class="container text-secondary">
                  <h3 class="text-secondary">Crée un compte</h3>
                    <p>vous povouver faire la création de compte client merci!</p>
                </div>
                <div class="col-md-12 py-4">
                    <label class="form-label" for="">Selectionner un Client</label>
                    <select require class="form-control" name="idclient" id="">
                    <?php
                            include("connexion.php");
                            $req=$con->query("SELECT * FROM `client`");
                            while($resultat=$req->fetch()){
                    ?>
                            <option value="<?php echo $resultat['idclient']; ?>">
                            <?php echo $resultat['nom']." ". $resultat['postnom'];  ?>
                            </option>
                        <?php
                            }
                            ?>
                ...
                <div class="col-md-12">
                    <label class="form-label" for="">Categorie compte</label>
                    <select class="form-control" name="nom_categoriecompte" id="" required>
                    <?php
                            include("connexion.php");
                            $req=$con->query(" SELECT * FROM `categoriecompte`");
                            while($resultat=$req->fetch()){
                    ?>
                            <option value="<?php echo $resultat['id_categoriecompte']; ?>">
                            <?php echo $resultat['nom_categoriecompte'];  ?>
                            </option>
                        <?php
                            }
                            ?>
                ...
                <div class="col-md-6 py-3">
                    ...
                    <a class="btn btn-danger" href="form_compte.php"><span><i class="fas fa-times"></i></span> Annuler</a>
                </div>
