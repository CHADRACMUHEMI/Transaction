...
<body id="page-top">
 ...
 <li class="nav-item dropdown no-arrow">
    ...
    <div class="col col-md-11 mx-11 shadow-lg">
            ...
            <?php
            include("save_categoriecompte.php"); 
            ?>
            <div class="row mx-2">
                <div class="container text-secondary">
                  <h3 style="color: #149ddd;">Ajoutez la catégorie de compte</h3>
                    <p>vous povouver faire un ajout ou l'augmentation du categorie merci!</p>
                </div>
                <div class="col-md-12">
                    <label class="form-label" for="">Nom du catégorie</label>
                    <input name="nom_categoriecompte" class="form-control" type="text" required>
                </div>
