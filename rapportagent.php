...
$pdf->Write(0, 'RAPPORT DE TOUT LES AGENTS ', '', 0, 'C', true, 0, false, false, 0);
...
$pdf->Write(0, '______________________________', '', 0, 'C', true, 0, false, false, 0);
...
//         // $numDomaine=0;
            ...
            $tbl .= '<tr>
                    <td align="left">'.$resultat["id_compteuser"].'</td>
                    <td align="left">'.$resultat["pseudo"].'</td>
                    <td align="left">'.$resultat["fonction"].'</td>
                    <td align="left">'.$resultat["date_user"].'</td>
                   </tr>';
            }
