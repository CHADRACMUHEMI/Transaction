...
<body id="page-top">
 ...
 <li class="nav-item dropdown no-arrow">
    ...
    <div class="col col-md-11 mx-11 shadow-lg">
            ...
            <?php
            include("save_compteapplication.php"); 
            ?>
            <div class="row mx-2">
                <div class="container text-secondary">
                  <h3 style="color: #149ddd;">Ajoutez la fonction</h3>
                    <p>vous povouver faire un ajout ou l'augmentation du compte application merci!</p>
                </div>
                <div class="col-md-12">
                    <label class="form-label" for="">Nom du fonction</label>
                    <input name="fonction" class="form-control" type="text" required>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-exclamation-triangle fa-2x text-danger"></i> Message d'alerte</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Voulez vous vous déconnecter sur cette page ?</div>
