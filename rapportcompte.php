...
$pdf->SetAuthor('james');
$pdf->SetTitle('LISTE DE compte');
$pdf->SetSubject('LISTE DE compte');
...
$pdf->Write(0, 'RAPPORT DE TOUT LE COMPTE ', '', 0, 'C', true, 0, false, false, 0);
...
$pdf->SetFont('helvetica', 'B', 14);
    ...
    // Consultation 
    $req = $con->query("SELECT * FROM `compte`INNER JOIN client ON client.idclient = compte.idclient INNER JOIN categoriecompte ON categoriecompte.id_categoriecompte = categoriecompte.id_categoriecompte");
...
//         // $numDomaine=0;
            ...
            $tbl .= '<tr>
                    <td align="left">'.$resultat["id_compte"].'</td>
                    <td align="left">'.$resultat["nom"].'</td>
                    <td align="left">'.$resultat["postnom"].'</td>
                    <td align="left">'.$resultat["nom_categoriecompte"].'</td>
                   </tr>';
            }
