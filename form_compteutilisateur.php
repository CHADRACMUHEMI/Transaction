...
<body id="page-top">
    ...
    <div class="col col-md-11 mx-11 shadow-lg">
            ...
            <?php
            include("save_utilisateur.php"); 
            ?>
            <div class="row mx-2">
                <div class="container text-secondary">
                  <h3 style="color: #149ddd;"><i class="fas fa-users"></i> Ajoutez l'utilisateur</h3>
                    <p>vous povouver faire un ajout ou l'augmentation des utilisateur merci!</p>
                </div>
                <div class="col-md-12">
                    <label class="form-label" for="">Nom / Post nom</label>
                    <input name="nom" class="form-control" type="text" required>
                </div>

                <div class="col-md-12">
                    <label class="form-label" for="">Mot de pass</label>
                    <input name="mot_de_passe" class="form-control" type="password" required>
                </div>

                <div class="col-md-12">
                    <label class="form-label" for="">Fonction</label>
                    <select  class="form-control" name="fonction" id="" required>
                    <?php
                            include("connexion.php");
                            $req=$con->query(" SELECT * FROM `compteapplication`");
                            while($resultat=$req->fetch()){
                    ?>
                            <option value="<?php echo $resultat['fonction']; ?>">
                            <?php echo $resultat['fonction'];  ?>
                            </option>
                        <?php
                            }
                            ?>
